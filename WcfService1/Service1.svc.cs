...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg = "";
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-4ON24VD\\MUAMMARSQL;Initial Catalog=pat_wcf;Persist Security Info=True;User ID=sa; Password=muammar310");
            con.Open();
